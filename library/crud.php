...
class Database {
    ...
    private $db_user = "perfectb_calender";  // Change as required
    private $db_pass = "holiday@123456";  // Change as required 
    private $db_name = "perfectb_calender"; // Change as required
