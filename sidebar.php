        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title text-center" style="border: 0;">
                   <h2 style="color:green;">Academic Calender</h2> 
                </div>
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <!--<li><a href ="home.php"><em class="fas fa-home"></em> Home</a></li>-->
                                ...
                                <li>
                                <a><em class="fas fa-book"></em> State Govt Calendar<span class="fas fa-caret-down"></span></a>
                                <ul class="nav child_menu">
                            ...
                            <li>
                                <a><em class="fas fa-book"></em> Academic Holiday<span class="fas fa-caret-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="academic.php">Add</a></li>
                                    <!-- <li><a href="sub-category.php">Sub Category</a></li>
                            ...
                            <li><a><em class="fas fa-book"></em> State Holiday<span class="fas fa-caret-down"></span></a>
                            <ul class="nav child_menu">
                                    <li><a href="add_pdf.php">Add</a></li>
</ul>
                        </li>
                         <li><a><em class="fas fa-book"></em> Banner Integration<span class="fas fa-caret-down"></span></a>
                            <ul class="nav child_menu">
                                    <li><a href="add_banner.php">Add</a></li>
</ul>
                        </li>
