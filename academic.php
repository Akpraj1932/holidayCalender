                            ...
                            <div class="x_content">
                                <div class='row'>
                                    <div class='col-md-12 col-sm-12'>
                                        <form action="add_academic_code.php" method="post" id="register_form"
                                            enctype="multipart/form-data">
                                            <input type="hidden" value="pdf_academic"
                                                name="pdf_academic" />
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <input type='file' name="image" id="image" class="form-control" accept=".doc,.pdf" required>
                                                </div>
                                                <hr>
                                 ...
                                 <div class="row">
                                        <div class='col-sm-12'>
                                            <h2>Academic Calender<small>View / Update / Delete</small></h2>
                                ...
                                <div class='col-md-12 col-sm-12'>
                                            ...
                                            <div class='row'>
                                                ...
                                                <table aria-describedby="mydesc" class='table-striped' id='category_list'
                                                       data-toggle="table" data-url="get-list.php?table=academic_calender"
                                                       data-click-to-select="true" data-side-pagination="server"
                                                       data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]"
                                                       data-search="true" data-show-columns="true"
                                                       data-show-refresh="true" data-trim-on-search="true"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <!--<th scope="col" data-field="pdf" >Show PDF</th>-->
                                                            <th scope="col" data-field="image" data-sortable="false">PDF</th>
                                                            <th scope="col" data-field="view" data-sortable="false">View</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="update_form"  method="POST" action ="add_academic_code.php" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="update_academic" value="update_academic"/>
                                   
                                                 <div class="col-md-6 col-sm-12">
                                                    <label for="name">State</label>
                                                    <select name="state" required class="form-control" id="state_1">
                                                        <option>Select State</option>
                                                        <?php
                                                    $sql="SELECT * FROM state";
                                                    $result= mysqli_query($conn,$sql);
